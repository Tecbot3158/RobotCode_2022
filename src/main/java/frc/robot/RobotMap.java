...
public class RobotMap {
    ...
    public static final double TURRET_MOTOR_MIN_ROTATIONS = -135 / (double) 360 * RobotMap.TURRET_ROTATION_TO_MOTOR_ROTATION;
    public static final double TURRET_MOTOR_MAX_ROTATIONS = 135 / (double) 360 * RobotMap.TURRET_ROTATION_TO_MOTOR_ROTATION;
