...
public class Paths {
        ...
        double[] fiveBallAutoPathXCoordinates = { 1.48, 5, 7.625 };
        double[] fiveBallAutoPathYCoordinates = { 2.5, 1.95, 1.83 };

        boolean fiveBallAutoPathVertical = false;

        public Paths() {

                CubicSpline testSpline0 = SplineGenerator.GenerateSpline0(testSplineXCoordinates[0],
                                testSplineXCoordinates[1],
                                testSplineXCoordinates[2], testSplineYCoordinates[0], testSplineYCoordinates[1],
                                testSplineYCoordinates[2]);

                CubicSpline testSpline1 = SplineGenerator.GenerateSpline1(testSplineXCoordinates[0],
                                testSplineXCoordinates[1],
                                testSplineXCoordinates[2], testSplineYCoordinates[0], testSplineYCoordinates[1],
                                testSplineYCoordinates[2]);

                testSpline = new PieceWiseSpline(testSpline0, testSpline1, testSplineXCoordinates[0],
                                testSplineXCoordinates[1],
                ...
                CubicSpline fiveBallAutoPathSpline0 = SplineGenerator.GenerateSpline0(fiveBallAutoPathXCoordinates[0],
                                fiveBallAutoPathXCoordinates[1], fiveBallAutoPathXCoordinates[2],
                                fiveBallAutoPathYCoordinates[0],
                ...
                fiveBallAutoPath = new PieceWiseSpline(fiveBallAutoPathSpline0, fiveBallAutoPathSpline0,
                                fiveBallAutoPathXCoordinates[0], fiveBallAutoPathXCoordinates[1],
                                fiveBallAutoPathXCoordinates[2],
                                false);
