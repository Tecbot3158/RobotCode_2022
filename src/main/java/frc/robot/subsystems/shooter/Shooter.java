...
public class Shooter extends SubsystemBase {
    ...
    public Shooter() {
        ...
        // shooterEncoder =
        // shooterMotors.getSpecificMotor(RobotMap.SHOOTER_ENCODER_MOTOR_PORT).
        // getCANSparkMax().getEncoder();

        // OJO AQUÍ
        shooterMotors.getSpecificMotor(
                RobotMap.SHOOTER_MOTOR_SLAVE_PORT).getCANSparkMax().follow(
                        shooterMotors.getSpecificMotor(
                                RobotMap.SHOOTER_MOTOR_MASTER_PORT).getCANSparkMax(),
                        true);

        shooterEncoder = shooterMotors.getSpecificMotor(RobotMap.SHOOTER_MOTOR_MASTER_PORT).getCANSparkMax()
                .getEncoder();
